      ...
      <div className="rounded-3xl border border-dashed bg-muted/40 p-10">
        <div className="space-y-3">
          ...
          <p className="max-w-3xl text-base text-muted-foreground">
            We frequently assemble hybrid pods that span these sectors. If you&apos;re launching a cross-discipline
            initiative, we&apos;ll craft a custom playbook and align on KPIs with your leadership team.
          </p>
        </div>
        <Button asChild variant="outline" className="mt-6">
          <Link href={`mailto:${siteConfig.contact.email}`}>Schedule a solutioning workshop</Link>
        </Button>
      </div>
    </Container>
  );
