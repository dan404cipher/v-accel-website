...
export function ComplianceSecurity() {
  return (
    <section className="py-20 lg:py-28 bg-gradient-to-br from-[#2C3E50] via-[#34495E] to-[#2C3E50] text-white relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-primary/10 rounded-full blur-xl"></div>
      <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-[#4DD0E1]/10 rounded-full blur-xl"></div>
