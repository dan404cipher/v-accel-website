...
const heroShapes = [
  ...
  {
    className:
      "bottom-16 right-[25%] w-6 h-6 border border-[#FF6B6B]/30 rotate-45",
...
export function TermsPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#F4F6F8] to-white text-[1rem] sm:text-[1.05rem]">
      {/* Hero */}
      <section className="relative overflow-hidden bg-gradient-to-br from-[#3E5266] via-[#3E5266] to-[#4A5568] pt-36 pb-28">
        <div className="absolute inset-0 opacity-30">
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(circle at top, rgba(0, 184, 169, 0.18), transparent 60%)",
            }}
          />
        </div>
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          {heroShapes.map((shape, idx) => (
            <div
              key={idx}
              className={`absolute ${shape.className} ${shape.animation}`}
            />
          ))}
        </div>
        ...
        <div className="max-w-5xl mx-auto px-6 sm:px-10 lg:px-14 relative z-10 text-center text-white">
          ...
          >
            ...
            <Badge className="mb-2 border-0 bg-white/15 text-white text-[0.75rem]">
              Legal Agreement
            </Badge>
            <h1 className="mb-3 text-[1.55rem] sm:text-[1.8rem] font-semibold text-white leading-tight">
              Terms & Conditions
            </h1>
            ...
            <div className="space-y-6 text-[1.25rem] sm:text-[1.3rem] font-semibold">
              ...
              >
                <Card className="p-6 shadow-lg hover:shadow-xl transition-shadow">
                  <header className="mb-5 flex items-start gap-4">
                    ...
                    <div>
                      <h2 className="text-[#1A2332] text-lg font-semibold mb-1">
                        1. Acceptance of Terms
                      </h2>
                      <Badge className="border-0 bg-[#00B8A9]/10 text-xs text-[#00B8A9]">
                        Required Reading
                      </Badge>
                    </div>
                  </header>
                  ...
                  <header className="mb-5 flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-[#2C3E50]">
                        V-Accel provides the following:
                      </p>
                    </div>
                  </header>
              ...
              >
                <Card className="p-6 shadow-lg hover:shadow-xl transition-shadow">
                  ...
                  <p className="text-sm text-[#2C3E50] mb-3 font-medium">
              ...
              <TermsSection
                ...
                badges={
                  <Badge className="border-0 bg-[#FF6B6B]/10 text-[#FF6B6B]">
                    Critical
                  </Badge>
                }
                content={
    ...
    <div>
      ...
      <div className="space-y-2">
        {items.map((item) => (
          <div
            key={item}
            className="flex items-start gap-2.5 rounded-lg bg-[#F4F6F8] p-3 text-[1.15rem] font-medium"
          >
...
function SubSection({
  ...
  return (
    <div className={baseClass}>
      ...
      <div className="text-[1.15rem] font-medium text-[#2C3E50] leading-relaxed">
        {children}
      </div>
    </div>
  );
...
function Callout({
  ...
  return (
    <div
      className={`rounded-r-lg border-l-4 ${palette.border} ${palette.bg} p-4 text-sm text-[#2C3E50] font-medium leading-relaxed`}
    >
      {children}
    </div>
  );
